...
import styles from './SolarStarBoldIcon.module.scss'

type SolarStarBoldIconProps = Omit<SVGProps<SVGSVGElement>, 'color'> & {
  size?: number | string
  color?: string
  title?: string
...
export function SolarStarBoldIcon({
  size = 24,
  color = 'currentColor',
  title,
  strokeWidth = 2,
