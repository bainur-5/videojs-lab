...
import styles from './SolarEyeLinearIcon.module.scss'

type SolarEyeLinearIconProps = Omit<SVGProps<SVGSVGElement>, 'color'> & {
  size?: number | string
  color?: string
  title?: string
...
export function SolarEyeLinearIcon({
  size = 24,
  color = 'currentColor',
  title,
  strokeWidth = 1.5,
